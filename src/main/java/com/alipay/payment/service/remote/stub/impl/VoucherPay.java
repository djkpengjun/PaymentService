...
@Component
public class VoucherPay implements PaymentRemoteSerivceStub {

    private Boolean isEnabled = false;

    @PostConstruct
    public void initialize() {
        PaymentType.VOUCHER_PAY.setPaymentRemoteSerivceStub(this);
    }

    @Override
    public ConsultResult isEnabled() {
        return new ConsultResult(isEnabled, isEnabled ? "" : "Not enough voucher");
    }
